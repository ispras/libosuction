...
echo $(simple_test_cpp overridden.cpp "dlsym set is not limited" 0 "Limited")
echo $(simple_test_cpp overridden.cpp "GetRealFunctionAddress\(const char\*\)->dlsym->\[foo\]" 1 "Symbol Set" )
