...
echo $(simple_test ifcallopt.c "dlsym matched to the signature" 2 "Signature"  )
echo $(simple_test ifcallopt.c "dlsym set state:CONSTANT" 1 "CONSTANT")
echo $(simple_test ifcallopt.c "dlsym set state:UNDEFINED" 1 "UNDEFINED")
echo $(simple_test ifcallopt.c "function_caller.constprop.0->dlsym->\[func_name\]" 1 "Symbol Set" )
